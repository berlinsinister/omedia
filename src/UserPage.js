...
class UserPage extends React.Component {
    ...
    render() {
        ...
        let { id, repos, orgs, isUser } = this.props;
            ...
            return (
                <div className="user-page">
                    <div className="header">
                        ...
                        <span className="material-icons close-icon" id="close" onClick={this.handleCloseClick}>close</span>
                    </div>
                    <div className="user">
            ...
            return (
                <div className="user-page">
                    ...
                    <div className="user-not-found">
                        <span className="material-icons search-off-icon-page">search_off</span>
                        user not found
                    </div>
                    <div className="footer">&copy; Malika Efremova | 2020 - 2021</div>
                </div>
